...
# -----------------------------------------------------------------------------
N <- c(6)                  # Number of nodes in the network
...
# Regime Parameters
# -----------------------------------------------------------------------------
M <- c(1)               # Number of regimes (network states)
...
# -----------------------------------------------------------------------------
T <- c(2000)            # Number of time steps per time series
...
n_ts <- 1                    # Number of time series to generate per condition
